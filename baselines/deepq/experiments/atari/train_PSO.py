    ...
    with U.make_session(24) as sess:
        with tf.device("/gpu:1"):
            ...
            while True:
                ...
                (group_best_return,) = pso_update(info["rewards"][-args.num_clones:])
                logger.log("best rewards: {}".format(group_best_return["clone_best"]))
                logger.log("last rewards: {}".format(info["rewards"][-args.num_clones:]))
